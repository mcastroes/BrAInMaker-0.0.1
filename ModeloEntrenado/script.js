...
async function generateResponseFromBot(prompt) {
    ...
    const modifiedPrompt = `${prompt}, eres mi profesor de matematicas personal, tienes la capacidad de responderme como un profesor de grado de universidad.`;
...
function appendMessage(message, isUser) {
    ...
    profileImage.src = isUser ? '../multimedia/user.png' : '../multimedia/bot.png'; // Se asigna la imagen en función de si el emisor es el usuario o el bot
